...
@Composable
fun FooterSeaction(onGetInClick: () -> Unit) {
    Box(
        modifier = Modifier
            .fillMaxSize()
            .height(200.dp)
...
fun HeaderSection() {
    Box(
        ...
        Column(
            ...
            Text(
                text = "Dowmload amd watch offline\nwhere you are", style = TextStyle(
                    color = Color.White,
                    fontSize = 18.sp,
                    textAlign = TextAlign.Center
                )
